...
This section summarizes an efficient and highly-scalable solver developed for the simulation of geophysical flows on a spherical surface (see [^1] and [^2] for details).

...
The most stringent costraint is the number of registers available per thread, here equal to $65,536 / 2048 = 32$. An insection using `nvcc -arch=sm_70 --ptxas-options` reveals $85$ registers needed by the main RK4 CUDA kernel:

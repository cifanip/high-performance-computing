...
### Algorithm Outline
We are given a list of $i=0,...,C-1$ collision sites containing the state vector of a pair of objects in orbit, e.g. two satellites, $\mathbf{x}_0^i$, $\mathbf{x}_1^i$. 

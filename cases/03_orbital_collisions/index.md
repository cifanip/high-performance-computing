...
with $h$ the time-step size. The slopes $\mathbf{k}_2$ and $\mathbf{k}_3$ require the computation of the state vector at point $\mathbf{X}_n + \frac{h}{2}\mathbf{k}_1$

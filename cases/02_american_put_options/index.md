...
$$
\widehat{\Pi}_Y(t) = \max\limits_{\tau \in \mathcal{Q}_{t,T}} \widetilde{\mathbb{E}} [ (e^{-r(\tau-t)} g(S(\tau)) | \mathcal{F}_W(t) ], \qquad (0.0)
$$
...
$$
\widehat{\Pi}_Y(t,S) = \max\limits_{\tau \in \mathcal{Q}_{t,T}} \widetilde{\mathbb{E}} [ (e^{-r(\tau-t)} g(S(\tau)) | S(t) ]. \qquad (0.1)
$$
